...
def ground_domain_problem(domain, problem, type):
    ...
    domain,
    problem,
    "test_RG/"+type+"_grounded_"+domain,
    "test_RG/"+type+"_grounded_"+problem
    ]
...
# grounded_domain_estimator = "test_RG/"+"est_grounded_"+domain_estimator
# grounded_problem_estimator = "test_RG/"+"est_grounded_"+problem_estimator
# output_est_plan_path = "test_RG/"+"output_est-"+network+".txt"
# est_plan_path = "test_RG/"+"est_plan-"+network+".txt"

# grounded_domain_estimator = "/s/chopin/l/grad/shadaab/Documents/Resiliency_Graph/test_RG/est_grounded_domain_all_faults-flare.pddl"
# grounded_problem_estimator = "/s/chopin/l/grad/shadaab/Documents/Resiliency_Graph/test_RG/est_grounded_problem-flare.pddl"
# output_est_plan_path = "test_RG/"+"output_est-"+network+".txt"
# est_plan_path = "test_RG/"+"est_plan-"+network+".txt"
...
# grounded_domain_sim = "/s/chopin/l/grad/shadaab/Documents/Resiliency_Graph/test_RG/org_grounded_domain-flare.pddl"
# grounded_problem_sim = "/s/chopin/l/grad/shadaab/Documents/Resiliency_Graph/test_RG/est_grounded_problem-flare.pddl"
# output_sim_plan_path = "test_RG/"+"output_org-"+network+".txt"
# sim_plan_path = "test_RG/"+"org_plan-"+network+".txt"
