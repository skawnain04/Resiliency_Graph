...
from pddlparse.parser_common import *
from pddlparse.errors import *
from pddlparse.tree_visitor import Visitable, TraversePDDLDomain, TraversePDDLProblem
from pddlparse.lisp_parser import parse_lisp_iterator
...
class Parser(object):
    ...
    def parse_domain(self, read_from_file=True):
        ...
        if read_from_file:
            ...
            with open(self.domFile) as file:
