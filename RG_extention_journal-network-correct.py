...
end_time = datetime.now()
time_taken = end_time - start_time
print(f"Time Taken for exe and check predicates for faults to Optimistic Model:{time_taken}")
...
end_time = datetime.now()
time_taken = end_time - start_time
print(f"Time Taken for ACTIONS exe and check predicates for faults to Optimistic Model:{time_taken}")
...
end_time = datetime.now()
time_taken = end_time - start_time
print(f"Time Taken for actions to convert from exe to check variables with cost to Optimistic Model:{time_taken}")
...
end_time = datetime.now()
time_taken = end_time - start_time
print(f"Time Taken for actions to convert from not exe to check with cost variables to Optimistic Model:{time_taken}")
...
end_time = datetime.now()
time_taken = end_time - start_time
print(f"Time Taken for acost=1 to every action to Optimistic Model:{time_taken}")
